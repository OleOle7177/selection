...
# after "deploy:update_code", :copy_yandex_metrics
# task :copy_yandex_metrics, roles => :app do
#   db_config = "#{shared_path}/database.yml"
#   run "cp #{db_config} #{release_path}/config/database.yml"
# end
...
# set :repository,      "git@github.com:OleOle7177/selection.git"

## Если ваш репозиторий в GitHub, используйте такую конфигурацию
set :repository,    "https://github.com/OleOle7177/selection.git"
